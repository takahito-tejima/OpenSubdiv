...
void
OsdUnivar4x4(in float t, out float B[4], out float D[4])
{
#if 0
    float t = u;
    float s = 1.0f - u;
    ...
    D[0] = -3.0f * tC2;
    D[1] =  9.0f * t2 - 12.0f * t + 3.0f;
    D[2] = -9.0f * t2 +  6.0f * t;
    D[3] =  3.0f * t2;
}

void
OsdUnivar4x4(in float t, out float B[4], out float D[4], out float C[4])
{
#if 0
    float t = u;
    float s = 1.0f - u;
    ...
    // Second derivatives of the above four basis functions at t:
    C[0] = -6.0f * t + 6.0f;
    C[1] =  18.0f * t - 12.0f;
    C[2] = -18.0f * t + 6.0f;
    C[3] =  6.0f * t;
